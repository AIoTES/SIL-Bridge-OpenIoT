...
public class OpenIoTPlatformEmulator {
    ...
    public OpenIoTPlatformEmulator(int port, int observationsDelay) {
        this.port = port;
        this.observationsDelay = observationsDelay;
    }

    public void start() throws Exception {
        logger.debug("OpenIoTPlatformEmulator is initializing...");
...
//            if (subscriptions.containsKey(subscriptionQuery)) {
 ...
 //           subscriptionThreads.put(subscriptionQuery, obsPublisherThread);
    ...
    public void stop() {
        ...
        logger.debug("OpenIoTPlatformEmulator has stoped.");
    }

    public static void main(String[] args) throws Exception {
        new OpenIoTPlatformEmulator(4568, 10).start();
    }
